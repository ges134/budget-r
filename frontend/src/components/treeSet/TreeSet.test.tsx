...
describe('Tree set', () => {
  ...
  describe('with only one item', () => {
    it('should render properly', () => {
      ...
      expect(rendered.find('li.space-0').length).toBe(1);
      expect(rendered.find('li.space-1').length).toBe(0);
  ...
  describe('with multiple children on a [1, 2, 2, 3, 3] structure', () => {
    it('should render properly', () => {
      ...
      expect(rendered.find('li.space-0').length).toBe(1);
      expect(rendered.find('li.space-1').length).toBe(2);
  ...
  describe('with multiple children on a [1, 1, 2, 3, 1, 2, 2, 3, 3, 1, 2, 3, 3, 2] structure', () => {
    it('should render properly', () => {
      ...
      expect(rendered.find('li.space-0').length).toBe(4);
      expect(rendered.find('li.space-1').length).toBe(5);
